...
public class SCR_Enemy : MonoBehaviour, IDamageble
{
    ...
    [SerializeField] private ParticleSystem infectionDisplay1;
    [SerializeField] private ParticleSystem infectionDisplay2;
    [SerializeField] private ParticleSystem infectionDisplay3;
    ...
    private IEnumerator DamageOverTime()
    {
        if (infectionDuration > 0 && enemyHealth > 0)
        {
            ...
            infectionDisplay1.Play();
            infectionDisplay2.Play();
            infectionDisplay3.Play();
